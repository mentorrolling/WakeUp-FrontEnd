      ...
      <div className="pedidos">
        ...
        <Row>
          <Col className="text-center d-flex flex-column align-items-center">
            ...
            <br />
            <Button className="botonhacerpedido"> Hacer pedido  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cup-hot" viewBox="0 0 16 16">
