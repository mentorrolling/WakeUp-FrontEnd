    ...
    <div>
      <div className="principal">
        <Row className="align-items-center">
          <Col className="text-center">
            <img className="logoedit img-fluid" 
            src={logo} 
            alt="logo" />
            ...
            <Link
                ...
                offset={-70}
                duration={500}> 
              <Button id="scrollButton" className="chevron">
              <svg 
      ...
      <div className="container mt-0 d-flex justify-content-center align-items-center">
        <Row>
          ...
          <Col md={6}> 
            <img className="img-fluid mx-auto juice mt-0" 
            src={juice} 
            alt="juice" />
          </Col>
        </Row>
      ...
      <Col md={4}>
      <div className="card">
        <img src={hotcoffee} className="card-img-top" alt="Imagen del producto" />
          <div className="card-body">
          <h5 className="card-title text-center">Hot Drinks</h5>
          <p className="card-text">Try the best coffees with the same premium quality as always</p>
          <a href="/menu" className="btn btn-primary d-flex justify-content-center ">See menu</a>
        </div>
      </div>
      </Col>
      <Col md={4}>
      <div className="card">
        <img src={coldcoffee} className="card-img-top" alt="Imagen del producto" />
          <div className="card-body">
          <h5 className="card-title text-center">Cold Drinks</h5>
          <p className="card-text">The Best fresh drinks juices and tea. Limited edition juices</p>
          <a href="/menu" className="btn btn-primary d-flex justify-content-center">See menu</a>
        </div>
      </div>
      </Col>
      <Col md={4}>
      <div className="card">
        <img src={bakery} className="card-img-top" alt="Imagen del producto" />
          <div className="card-body">
          <h5 className="card-title text-center">Bakery</h5>
          <p className="card-text">Fresh snacks of the day to accompany your drink</p>
          <a href="/menu" className="btn btn-primary d-flex justify-content-center"> See menu</a>
        </div>
         </div>
       </Col>
